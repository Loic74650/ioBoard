...
<li>{"TI":[125643,..]}      -> TeleInfo data. The following data is returned: [ADCO,OPTARIF,ISOUSC,BASE,IINST,PAPP,ADPS,IMAX,PTEC]. Refer to this reference for more info: https://www.enedis.fr/sites/default/files/Enedis-NOI-CPT_02E.pdf</li>
</ul>
<br />
